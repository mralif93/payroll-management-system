...
{
    /**
     * Seed 12 full months of last year (2025) payroll runs and auto-compile 2025 Form EA records.
     */
    public function run(): void
    {
        ...
        // Seed 12 months for 2025
        for ($month = 1; $month <= 12; $month++) {
            $batchNo = sprintf('RUN-%04d-%02d-AUTO', $year, $month);
            ...
            foreach ($employees as $employee) {
                ...
                if ($empType === 'freelance_contract' || $empType === 'intern') {
                    ...
                    // Standard Local (Muhammad Alif, Nurul Ain)
        ...
        // Auto-compile 2025 Form EA records
        foreach ($employees as $employee) {
