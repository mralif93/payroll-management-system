...
class UserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        AuditTrail::create([
            ...
            'module' => 'users',
            'event' => 'user_created',
            'description' => "Created new administrator user account '{$user->name}' ({$user->email})",
            'old_values' => null,
            'new_values' => [
                'name' => $user->name,
                'email' => $user->email,
    ...
    public function update(Request $request, User $user): RedirectResponse
    {
        ...
        AuditTrail::create([
            ...
            'module' => 'users',
            'event' => 'user_updated',
            'description' => "Updated user profile & permissions for '{$user->name}'",
            'old_values' => $oldState,
            'new_values' => [
                'name' => $user->name,
                'email' => $user->email,
    ...
    public function destroy(Request $request, User $user): RedirectResponse
    {
        ...
        AuditTrail::create([
            ...
            'module' => 'users',
            'event' => 'user_deleted',
            'description' => "Deleted administrator account '{$oldName}'",
    ...
    public function resetPassword(Request $request, User $user): RedirectResponse
    {
        ...
        AuditTrail::create([
            ...
            'description' => "Reset password for user account '{$user->name}'",
            'old_values' => null,
    ...
    public function toggleStatus(Request $request, User $user): RedirectResponse
    {
        ...
        AuditTrail::create([
            ...
            'description' => "Account {$actionText} for '{$user->name}'",
