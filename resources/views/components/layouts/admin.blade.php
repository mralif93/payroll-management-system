    ...
    <aside id="admin-sidebar" class="fixed inset-y-0 left-0 -translate-x-full xl:translate-x-0 xl:static w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col shrink-0 z-50 transition-transform duration-300 ease-in-out">
        ...
        <nav class="flex-1 px-3.5 py-5 space-y-6 overflow-y-auto text-xs">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.employees.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition {{ request()->routeIs('admin.employees.index') || request()->routeIs('admin.employees.show') ? 'bg-indigo-600 text-white shadow-md shadow-indigo-500/20 font-bold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white' }}">
                    <i class="bx bx-group text-lg"></i>
                    <span>Staff Directory</span>
                </a>
                <a href="{{ route('admin.employees.statutory') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition {{ request()->routeIs('admin.employees.statutory') ? 'bg-indigo-600 text-white shadow-md shadow-indigo-500/20 font-bold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white' }}">
                    <i class="bx bx-wallet-alt text-lg"></i>
                    <span>Salary &amp; Statutory Profiles</span>
                </a>
